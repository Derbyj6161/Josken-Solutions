...
function resumatorApplyToggleszN4zIvSCi(){
	var resumatorApplyForm = document.getElementById("resumator-applyform-szN4zIvSCi");
	var resumatorApplyFrame = document.getElementById("resumator-applyframe-szN4zIvSCi");
	var resumatorApplyButton = document.getElementById("resumator-applybutton-szN4zIvSCi");
	...
	if( resumatorApplyForm.style.display != "block" ){
		...
		resumatorApplyFrame.src = "https://joskensolutions.applytojob.com/apply/embed/form/szN4zIvSCi?source="+encodeURIComponent(resumatorSource);
	}else{
